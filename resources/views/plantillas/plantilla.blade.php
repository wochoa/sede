...
$dnsserver='http://gestionportales.regionhuanuco.gob.pe';//$dnsserver;
...
<style type="text/css" media="screen">
  ...
  <div class="wrapper">
      <nav class="navbar navbar-expand-lg fixed-top navbar-dark" style="background-color:{{ $tematm["tmcolor_tema"]}}; color:#fff;">
    	   <div class="container">
    	  	  <a class="navbar-brand mr-auto mr-lg-0" href="/"><img src="{{ $dnsserver }}/storage/{{substr($tematm["tmlogo_tema"],7) }}" height="40" /></a>
  ...
  <footer class="main-footer fondo7">
    ...
    <div class="row">
      <div class="col-md-3">
        <!-- ubicacion -->
        <a class="navbar-brand mr-auto mr-lg-0" href="/"><img src="{{ $dnsserver}}/storage/{{substr($tematm["tmlogo_tema"],7) }}" height="50"></a>
        {!! $tematm["tmfooter_f1"] !!} 
      </div>
      <div class="col-md-6">
